...
$CountStagiaires = $GestionStagiaire->CountStagiaires();



$DataVilles = [];
foreach ($CountStagiaires as $ville) {
    $DataVille = array(
        "y" => $ville["CountStagiaire"],
        "label" => $ville["Ville"]
    );
    array_push($DataVilles, $DataVille);
}
            ...
            ?>
                <tr>
                    ...
                    <td>
                        ...
                        ?>
                                <a href="editer.php?id=<?= $_SESSION["id"] ?>" style="color: green;">Éditer</a>
                                <a href="supprimer.php?id=<?= $_SESSION["id"] ?>" style="color: red;">Supprime</a>
    ...
    <script>
        window.onload = function() {
            ...
            var chart = new CanvasJS.Chart("chartContainer", {
                ...
                theme: "light2",
                title: {
                    text: "Stagiaires Villes"
                },
                axisY: {
                    title: "Stagiaires Count"
                },
                data: [{
                    type: "column",
                    yValueFormatString: "#,##0.## Trainner",
                    dataPoints: <?php echo json_encode($DataVilles, JSON_NUMERIC_CHECK); ?>
                }]
            });
            chart.render();
